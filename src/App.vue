      ...
      <div class="game-container">
        <div class="team">
          <h2>TeamA</h2>
              ...
              <img  v-if="teamAChoice ==='Scissors'" src="/src/assets/scissor.png" alt="Scissors">
              <img  v-if="teamAChoice ==='Luv'" src="/src/assets/luv.png" alt="Luv">
        </div>
        <div class="team">
          <h2>TeamB</h2>
          <img  v-if="teamAChoice ===''" src="/src/assets/rock.png" alt="Rock">
              ...
              <img  v-if="teamBChoice ==='Scissors'" src="/src/assets/scissor.png" alt="Scissors">
              <img  v-if="teamBChoice ==='Luv'" src="/src/assets/luv.png" alt="Luv">
        </div>
        <div class="score">
          <p>{{ scoreOutput }}</p>
        </div>
...
<style scoped>
body{
  background-color: rgb(242, 239, 55);
  margin: 0%;
  padding: 0%;
}
